...
function cos_enqueue_assets() {
	...
	wp_localize_script( 'cos-saved-buildings', 'cosSavedBuildingsData', array(
		...
		'categoriesEndpoint'    => esc_url_raw( rest_url( 'wp/v2/cos_category' ) ),
		'lang'                  => $is_sv ? 'sv' : 'en',
		'labels'                => array(
			'saveLabel'       => $is_sv ? __( 'Spara', 'cos-theme' ) : __( 'Save', 'cos-theme' ),
			'savedLabel'      => $is_sv ? __( 'Sparad', 'cos-theme' ) : __( 'Saved', 'cos-theme' ),
			'loading'         => $is_sv ? __( 'Laddar dina sparade platser…', 'cos-theme' ) : __( 'Loading your saved places…', 'cos-theme' ),
			...
			'compareFields'   => array(
				...
				'categories'    => $is_sv ? __( 'Kategorier', 'cos-theme' ) : __( 'Categories', 'cos-theme' ),
