...
<div class="container section support-us">
	<div class="support-us__row">
		<div class="support-us__col-main">
			<p>
				<?php
				if ( $is_sv ) {
		...
		<div class="support-us__col-aside">
			<div class="support-us__box">
				<h2><?php echo esc_html( $is_sv ? 'Donera' : 'Donate' ); ?></h2>
				<p>
					<?php
					if ( $is_sv ) {
...
<section class="section section--beige">
	<div class="container support-us">
		<div class="support-us__row">
			<div class="support-us__col-main">
...
<div class="container section support-us support-us__about">
	<h2><?php echo esc_html( $is_sv ? 'Om oss' : 'About us' ); ?></h2>

	<?php if ( $is_sv ) : ?>
		<p><?php esc_html_e( 'Castles of Sweden grundades 2018 av Victor Nordquist och Thor Övrelid.', 'cos-theme' ); ?></p>
		<p><?php esc_html_e( 'Innan Victor ägnade sig åt förmedling av Sveriges kulturarv arbetade han i ett decennium inom diplomati och finans. Därefter bytte han bana för att studera konsthistoria och avlade en masterexamen i konstvetenskap. Han har även en kandidatexamen i teologi från Uppsala universitet samt en kandidatexamen i statsvetenskap från Lunds universitet.', 'cos-theme' ); ?></p>
		<p><?php esc_html_e( 'Till vardags arbetar Thor Övrelid som senior politisk rådgivare, men är också historiker med ett starkt intresse för Sveriges historia. Han har en masterexamen i historia från Uppsala universitet samt en Master of Social Science (MSSc) i freds- och konfliktstudier från University College London.', 'cos-theme' ); ?></p>
		<p><?php esc_html_e( 'Tillsammans grundade de Castles of Sweden med ambitionen att göra landets slott, herrgårdar och historiska gods mer tillgängliga genom välunderbyggda och engagerande berättelser.', 'cos-theme' ); ?></p>
	<?php else : ?>
		<p><?php esc_html_e( 'Castles of Sweden was founded in 2018 by Victor Nordquist and Thor Övrelid.', 'cos-theme' ); ?></p>
		<p><?php esc_html_e( 'Before dedicating himself to the study and communication of Sweden\'s cultural heritage, Victor spent a decade working in diplomacy and finance. He later changed paths to pursue art history, earning an MA in Art History. He also has a BA in Theology from Uppsala University, as well as a BSc in Political Science from Lund University.', 'cos-theme' ); ?></p>
		<p><?php esc_html_e( 'By day, Thor Övrelid is a senior political adviser; by night, a historian with a passion for Sweden\'s past. He holds an MA in History from Uppsala University and an MSSc in Peace and Conflict Studies from University College London.', 'cos-theme' ); ?></p>
		<p><?php esc_html_e( 'Together, they founded Castles of Sweden to make the country\'s castles, manor houses and historic estates more accessible through well-researched, engaging storytelling.', 'cos-theme' ); ?></p>
	<?php endif; ?>
</div>
