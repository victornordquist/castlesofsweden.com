...
require_once COS_CORE_DIR . 'includes/class-building-proximity.php';
require_once COS_CORE_DIR . 'includes/class-share-image-generator.php';
...
require_once COS_CORE_DIR . 'includes/class-mailchimp.php';
...
COS_Building_Proximity::init();
COS_Share_Image_Generator::init();
