    ...
    if (this._running >= this.concurrency) {
      ...
      if (this.timeout !== void 0) {
        ...
        if (await Promise.race([
          ...
          throw this.queue.splice(this.queue.indexOf(r), 1), new E();
      } else
        await t;
    }
    this._running++;
...
function m(...i) {
  ...
  let t = i.join("/");
  const r = t[0] === "/", s = e(t);
  return t = c(t), !t && !r && (t = "."), t && s && !e(t) && (t += "/"), t;
}
function I(i, e) {
...
function P(i, e) {
  return i === "/" ? !0 : (i = c(i), e = c(e), e.startsWith(i + "/") || e === i);
}
function H(i) {
  return m("/", c(i || "/"));
}
...
function j(i) {
  return S(async function(e, t) {
    let r = 0, s = !1, o = !1, n = !1, l;
    ...
    t.on("stdin", (a) => {
      if (s || (s = !0, i.dispatchEvent({
        ...
        try {
          l.error(
            new Error(
              `sendmail: Message size exceeds fixed maximum message size (${d})`
            )
          );
        } catch {
        }
    ...
    const f = t.childProcess.stdin;
    if (f.ended || f.writableEnded || f.writableFinished || await new Promise((a) => {
      if (f.ended || f.writableEnded || f.writableFinished) {
        a();
        return;
      }
      const y = () => {
          ...
          if (typeof n == "object")
            try {
              l = JSON.stringify(
                ...
                (u, f) => typeof f == "bigint" ? `0x${f.toString(16)}` : f,
                2
              );
            } catch {
            }
...
function $(i) {
  return U(i.map((e) => new Uint8Array(e))).buffer;
}
export {
  E as AcquireTimeoutError,
  g as EventEmitterPolyfill,
  v as PhpWasmError,
  d as SENDMAIL_CAPTURE_MAX_SIZE,
  D as Semaphore,
  h as WritablePolyfill,
  W as basename,
  $ as concatArrayBuffers,
  U as concatUint8Arrays,
  S as createSpawnHandler,
  z as dirname,
  H as ensureAbsolutePath,
  P as isParentOf,
  m as joinPaths,
  c as normalizePath,
  O as phpEventStdinTransfer,
  B as phpVar,
  F as phpVars,
  Q as randomFilename,
  A as randomString,
  I as resolvePathUnder,
  j as sendmailSpawnHandler,
  x as splitShellCommand,
  C as sprintf,
  N as toPosixPath
};
