...
let i = 0;
const u = "/wordpress/wp-content/debug.log", b = async (e) => await e.fileExists(u) ? await e.readFileAsText(u) : "", $ = (e, r) => {
...
export {
  ...
  W as clearMemoryLogs,
  $ as collectPhpLogs,
  D as collectWindowErrors,
  u as errorLogPath,
  S as formatLogEntry,
  f as logEvent,
  E as logEventType,
  ...
  J as reportServiceWorkerMetrics
};
