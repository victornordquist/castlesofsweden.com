"use strict";Object.defineProperty(exports,Symbol.toStringTag,{value:"Module"});const p="playground-log",f=(e,...r)=>{E.dispatchEvent(new CustomEvent(p,{detail:{log:e,args:r}}))},v=(e,...r)=>{switch(typeof e.message=="string"?Reflect.set(e,"message",l(e.message)):e.message.message&&typeof e.message.message=="string"&&Reflect.set(e.message,"message",l(e.message.message)),e.severity){case t.Debug:console.debug(e.message,...r);break;case t.Info:console.info(e.message,...r);break;case t.Warn:console.warn(e.message,...r);break;case t.Error:console.error(e.message,...r);break;case t.Fatal:console.error(e.message,...r);break;default:console.log(e.message,...r)}},P=e=>e instanceof Error?[e.message,e.stack].join(`
