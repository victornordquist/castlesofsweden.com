import { isLegacyPHPVersion as E, setPhpIniEntries as v, withPHPIniValues as I, sandboxedSpawnHandlerFactory as z, PHPRequestHandler as j, PHP as Z, writeFiles as A } from "@php-wasm/universal";
import { joinPaths as l, phpVar as f, dirname as w, normalizePath as J, resolvePathUnder as ee, phpVars as k, basename as te } from "@php-wasm/util";
import { unzipFile as T, createMemoizedFetch as D } from "@wp-playground/common";
import { logger as $ } from "@php-wasm/logger";
async function F(e) {
  await e.writeFile(
...
async function ae(e, t) {
  return W(e, t) ? (await le(e, t), await _e(e, t), await ce(e, t), await ue(e, t), await de(e, t), await fe(e, t), await he(e, t), !0) : !1;
}
async function oe(e) {
  return W(e, e.documentRoot) ? (await e.run({
    code: `<?php
...
function W(e, t) {
  const i = l(t, "b2config.php"), n = l(t, "b2-include/b2vars.php");
  return !e.fileExists(i) || !e.fileExists(n) ? !1 : e.readFileAsText(n).includes("$b2_version = '0.71'");
}
async function le(e, t) {
  for (const i of [
    l(t, "wp-includes"),
    l(t, "wp-content"),
    l(t, "wp-content/database")
  ])
    e.isDir(i) || await e.mkdir(i);
}
async function _e(e, t) {
  const i = l(t, "wp-includes/version.php");
  await e.writeFile(
    i,
    `<?php
$wp_version = '0.71';
...
async function de(e, t) {
  const i = l(t, "b2-include/wp-db.php");
  let n = e.readFileAsText(i);
  const s = n;
  n = pe(n), n = n.replace(
...
async function he(e, t) {
  await $e(e, t), await ge(e, t), await me(e, t), await Te(e, t);
}
async function $e(e, t) {
  const i = l(t, "b2login.php");
  let n = e.readFileAsText(i);
  const s = n;
  n.includes("pg_wp07_login_auto_login") || (n = n.replace(
    "switch($action) {",
    `${G("pg_wp07_login_auto_login")}
switch($action) {`
...
async function ge(e, t) {
  const i = l(t, "wp-admin");
  if (e.isDir(i))
    for (const n of e.listFiles(i)) {
      if (!n.endsWith(".php")) continue;
      const s = l(i, n), r = e.readFileAsText(s), a = q(r);
      a !== r && await e.writeFile(s, a);
    }
}
async function me(e, t) {
  const i = l(t, "wp-admin/b2menutop.php");
  let n = e.readFileAsText(i);
  const s = n;
  n = n.replace(
    'file("./b2menutop.txt")',
...
async function Te(e, t) {
  const i = l(t, "wp-admin/b2verifauth.php");
  let n = e.readFileAsText(i);
  const s = n;
  n.includes("pg_wp07_auto_login") || (n = n.replace(
    "require_once('../b2config.php');",
    `require_once('../b2config.php');
${G("pg_wp07_auto_login")}`
  ), n !== s && await e.writeFile(i, n));
}
function G(e) {
  return `
...
async function Ee(e, t) {
  ...
  if (!Number.isFinite(n) || n < 5 || n >= 6.2)
    return;
  const s = l(t, "wp-includes/load.php");
...
const we = 22527, b = "E_ALL & ~8192 & ~2048";
async function Le(e, t) {
  if (await ae(e, t)) return;
  await Re(e, t), await Ie(e, t), await ke(e, t), await qe(e, t), await We(e, t), await ze(e, t), await Me(e, t), await Ye(e, t), await Ne(e, t), await Oe(e, t);
  const i = y(e, t);
  if (i === null) return;
  const n = parseFloat(i);
  Number.isFinite(n) && (n < 1.2 && (await ve(e, t), await xe(e, t)), n < 1.5 && await Ae(e, t), 1.5 <= n && n < 2 && await Xe(e, t), n < 2 && (await Pe(e, t), await Ce(e, t)), 2.1 <= n && n < 2.3 && await Se(e, t), n < 2.5 && await Be(e, t), n < 2.8 && (await Ke(e, t), await Qe(e, t)), 2.9 <= n && n < 3.6 && await be(e, t), 3.3 <= n && n < 3.4 && await Ue(e, t), n >= 4.7 && await ye(e, t));
}
async function ye(e, t) {
  const i = l(t, "wp-content/themes");
  if (e.isDir(i))
    for (const n of e.listFiles(i)) {
      const s = l(i, n, "searchform.php");
      e.fileExists(s) && e.unlink(s);
    }
}
async function be(e, t) {
  const i = l(t, "wp-admin/includes/dashboard.php");
  if (e.fileExists(i)) {
  ...
  const n = l(t, "wp-admin/admin.php");
  if (e.fileExists(n)) {
...
do_action('admin_init');`
    ...
    if (!r.includes("/* pg_admin_no_updates */")) {
      for (const a of [
        ...
        o.test(r) && (r = r.replace(
          o,
          (_) => _ + " /* pg_admin_no_updates */ return;"
        ));
      }
  ...
  for (const r of [
    l(t, "wp-includes/SimplePie/File.php"),
    l(t, "wp-includes/class-simplepie.php")
  ]) {
...
async function Oe(e, t) {
  const i = [
    ...
    l(t, "wp-admin/includes/upgrade.php"),
    l(t, "wp-admin/upgrade-functions.php")
  ];
  for (const s of n) {
    ...
    for (const [o, _] of i) {
      ...
      if (c === -1) continue;
      const d = r.indexOf("{", c);
      d !== -1 && (r = r.substring(0, d + 1) + ` /* ${_} */ return;` + r.substring(d + 1), a = !0);
    }
    a && await e.writeFile(s, r);
  }
}
async function Ne(e, t) {
  const i = l(t, "wp-load.php");
...
async function Ae(e, t) {
  ...
  if (e.fileExists(n)) {
    ...
    if (!r.includes("/* pg_wp12_logo_link */")) {
      const a = '<a href="http://wordpress.org" rel="external"', o = "</a>", _ = r.indexOf(a);
      if (_ !== -1) {
        const c = r.indexOf(o, _);
        if (c !== -1) {
          const d = r.substring(0, _) + '<a href="#">WordPress</a><!-- pg_wp12_logo_link -->' + r.substring(c + o.length);
          d !== r && await e.writeFile(n, d);
        }
      }
    }
  }
...
async function Ue(e, t) {
  const i = l(t, "wp-admin/includes/screen.php");
  if (!e.fileExists(i)) return;
  const n = e.readFileAsText(i);
...
async function Se(e, t) {
  const i = l(t, "wp-admin/plugins.php");
  if (!e.fileExists(i)) return;
  const n = e.readFileAsText(i);
...
async function Re(e, t) {
  const i = l(t, "wp-includes");
  if (!e.isDir(i)) return;
  const n = l(i, "version.php");
  e.fileExists(n) || await e.writeFile(n, "<?php $wp_version = '1.0';");
}
async function ve(e, t) {
  const i = l(t, "wp-blog-header.php");
  if (e.fileExists(i)) {
  ...
  const n = l(t, "wp-includes/vars.php");
  if (e.fileExists(n)) {
...
if (!defined('WP_CONTENT_DIR')) define('WP_CONTENT_DIR', ABSPATH . 'wp-content');`
  )), s = s.replace(/unset\(\s*\$wp_filter\s*,/, "unset("), s = De(s), s = Fe(s), s !== n && await e.writeFile(i, s);
}
function De(e) {
...
async function qe(e, t) {
  const i = l(t, "wp-admin/install.php");
  if (!e.fileExists(i)) return;
  const n = e.readFileAsText(i);
  let s = n;
  const r = l(t, "wp-admin");
...
async function We(e, t) {
  const i = l(t, "wp-includes/wp-db.php");
  if (!e.fileExists(i)) return;
  const n = e.readFileAsText(i);
  let s = n;
...
async function Me(e, t) {
  ...
  if (e.isDir(i))
    for (const r of e.listFiles(i)) {
      ...
      const a = l(i, r), o = e.readFileAsText(a), _ = q(o).replace(/ABSPATH\s*\.\s*'\/wp-/g, "ABSPATH . 'wp-");
      _ !== o && await e.writeFile(a, _);
    }
  const n = l(t, "wp-admin/index.php");
  if (e.fileExists(n)) {
    let r = e.readFileAsText(n);
  ...
  const s = l(t, "wp-admin/menu.php");
  if (e.fileExists(s)) {
    const r = e.readFileAsText(s), a = "file('./menu.txt')";
    r.includes(a) && await e.writeFile(
      s,
      r.replace(a, "file(dirname(__FILE__) . '/menu.txt')")
    );
  }
}
async function Be(e, t) {
...
async function Xe(e, t) {
  const i = l(t, "wp-admin/index.php");
  if (e.fileExists(i)) {
...
async function Ve(e, t) {
  const i = l(t, "wp-includes/rss-functions.php");
  if (!e.fileExists(i)) return;
  let n = e.readFileAsText(i);
...
async function Ke(e, t) {
  const i = l(t, "wp-admin/admin.php");
  if (e.fileExists(i)) {
...
if (defined('PLAYGROUND_AUTO_LOGIN_AS_USER')) {
	if (function_exists('is_user_logged_in') && is_user_logged_in()) {
		...
		${M("PLAYGROUND_AUTO_LOGIN_AS_USER")}
...
async function Qe(e, t) {
  const i = l(t, "wp-admin/admin-ajax.php");
  if (!e.fileExists(i)) return;
  let n = e.readFileAsText(i);
...
async function ze(e, t) {
  ...
  if (!e.fileExists(s)) return;
  const r = e.readFileAsText(s);
  /\$wp_queries\s*=\s*"CREATE TABLE/.test(r) && !r.includes("function wp_get_db_schema") && await je(e, t, s, r);
}
async function je(e, t, i, n) {
  ...
  if (o === -1)
    return;
  const _ = o + a.length, d = `function wp_get_db_schema( $scope = 'all', $blog_id = null ) {
	...
	${n.substring(r, _)}
	return $wp_queries;
}`, p = n.substring(0, r) + d + n.substring(_);
  await e.writeFile(i, p);
  const u = l(
    t,
    "wp-admin/includes/upgrade.php"
  );
  if (e.fileExists(u)) {
    const h = e.readFileAsText(u), N = h.replace(
      /(\$alterations\s*=\s*dbDelta\(\s*\$wp_queries\s*\))/g,
      "if ( function_exists('wp_get_db_schema') ) { $wp_queries = wp_get_db_schema(); } $1"
    );
    N !== h && await e.writeFile(u, N);
  }
}
function Ze() {
  return `<?php
...
async function Je(e, t) {
  ...
  let i = null;
  const n = l(e.documentRoot, "wp-includes/version.php");
  if (e.fileExists(n)) {
  ...
  try {
    ...
    $.warn("Legacy WP post-install fixups failed (non-fatal):", r);
  }
  if (s)
    try {
      await e.run({
      ...
      $.warn("Legacy WP PDO fallback failed (non-fatal):", r);
    }
}
const et = `
...
async function tt(e, t, i = {}) {
  await e.isDir("/tmp/sqlite-database-integration") && await e.rmdir("/tmp/sqlite-database-integration", {
    recursive: !0
  }), await e.mkdir("/tmp/sqlite-database-integration"), await T(e, t, "/tmp/sqlite-database-integration");
  ...
  const o = l(await e.documentRoot, "wp-content/db.php"), _ = "/internal/shared/mu-plugins/sqlite-database-integration.php", c = `
if(file_exists(${f(o)})) {
	$_pg_db_php = @file_get_contents(${f(o)});
...
const g = 512, P = "/__tar-root__", st = [40, 181, 47, 253], rt = [80, 75, 3, 4], O = new TextDecoder();
function at(e) {
  return st.every((t, i) => e[i] === t);
}
function Xt(e) {
  return rt.every((t, i) => e[i] === t);
}
function ot(e) {
  const t = String(e);
  if (t.includes("\\"))
...
function lt(e, t) {
  ...
  if (i !== n)
    throw new Error(
      `Malformed tar stream: invalid header checksum for ${t || "unknown"}`
    );
}
class _t {
  constructor({ onEntry: t } = {}) {
    this.leftover = new Uint8Array(0), this.state = "header", this.entry = null, this.dataChunks = [], this.dataFilled = 0, this.padRemaining = 0, this.pendingLongName = null, this.pendingPax = null, this.zeroBlocks = 0, this.maxBuffered = 0, this.fileCount = 0, this.dirCount = 0, this.phpCount = 0, this.bytesWritten = 0, this.onEntry = t ?? (() => {
    });
  }
  push(t) {
    if (t != null && t.length)
      if (this.leftover.length === 0)
        ...
        const i = new Uint8Array(
          this.leftover.length + t.length
        );
        i.set(this.leftover, 0), i.set(t, this.leftover.length), this.leftover = i;
      }
    this.track(), this.drain();
  }
  end() {
    var t, i, n, s;
    if (this.state === "data" && this.dataFilled < (((t = this.entry) == null ? void 0 : t.size) ?? 0))
      throw new Error(
  ...
  track(t = 0) {
    const i = this.leftover.length + this.dataFilled + t;
    i > this.maxBuffered && (this.maxBuffered = i);
  }
  drain() {
    let t = !0;
    for (; t; ) {
      if (t = !1, this.state === "header") {
        if (this.leftover.length < g) break;
        const i = this.leftover.subarray(0, g);
        if (this.leftover = this.leftover.subarray(g), S(i)) {
          this.zeroBlocks += 1, this.zeroBlocks >= 2 && (this.state = "done"), t = !0;
          continue;
        }
        this.zeroBlocks = 0;
        const n = B(i, 124, 12), s = String.fromCharCode(i[156]) || "0", r = U(i, 0, 100), a = U(i, 345, 155);
        ...
        this.entry = {
          ...
          isLongLink: s === "L",
          isPaxHeader: s === "x"
        }, this.dataChunks = [], this.dataFilled = 0, n > 0 ? this.state = "data" : this.finishEntry(), t = !0;
        continue;
      }
      if (this.state === "data") {
        ...
        this.dataChunks.push(this.leftover.subarray(0, n)), this.dataFilled += n, this.leftover = this.leftover.subarray(n), this.track(), this.dataFilled === this.entry.size && this.finishEntry(), t = !0;
        continue;
      }
      if (this.state === "pad") {
        if (this.padRemaining === 0) {
          this.state = "header", t = !0;
          continue;
        }
        if (this.leftover.length === 0) break;
        const i = Math.min(this.padRemaining, this.leftover.length);
        this.leftover = this.leftover.subarray(i), this.padRemaining -= i, t = !0;
        continue;
      }
      if (this.state === "done") {
        if (this.leftover.length === 0) break;
        ...
        this.leftover = new Uint8Array(0), t = !0;
      }
    }
  }
  concatData() {
    const t = new Uint8Array(this.dataFilled);
    let i = 0;
  ...
  finishEntry() {
    var o;
    const t = this.entry, i = this.concatData();
    this.dataChunks = [];
    const n = t.size % g;
    if (this.padRemaining = n === 0 ? 0 : g - n, this.state = this.padRemaining > 0 ? "pad" : "header", this.dataFilled = 0, this.entry = null, t.isLongLink) {
      this.pendingLongName = O.decode(i).replace(/\0.*$/, "");
      return;
    }
    if (t.isPaxHeader) {
    ...
    const s = ((o = this.pendingPax) == null ? void 0 : o.path) ?? this.pendingLongName ?? (t.prefix ? `${t.prefix}/${t.name}` : t.name);
    this.pendingLongName = null, this.pendingPax = null;
    const r = t.typeflag === "5" || s.endsWith("/"), a = ot(s);
    if (a) {
      if (r) {
        this.dirCount += 1, this.onEntry({ type: "dir", path: a });
        return;
      }
      if (t.typeflag !== "0" && t.typeflag !== "\0")
        throw new Error(
          `Unsupported tar entry type "${t.typeflag}" for ${s}`
        );
      this.fileCount += 1, this.bytesWritten += i.length, a.endsWith(".php") && (this.phpCount += 1), this.onEntry({ type: "file", path: a, data: i });
    }
  }
}
async function ct(e, t) {
  ...
  if (typeof DecompressionStream < "u")
    try {
      const n = new DecompressionStream(t);
      return i.pipeThrough(n);
    } catch {
    }
  if (t === "zstd") {
    const { ZSTDDecoder: n } = await import("./zstddec-stream.modern-C2FJ34ZP.js"), s = new n();
    await s.init();
    const r = await pt(e), a = s.decodeStreaming(r);
    let o = !1;
    return new ReadableStream({
      ...
      cancel() {
        var _;
        o = !0, (_ = a.return) == null || _.call(a, void 0);
      }
    });
  }
  throw new Error(`No streaming decoder available for codec "${t}".`);
}
async function ut(e, t, i, n = {}) {
  const { onProgress: s = () => {
  }, overwriteFiles: r = !0 } = n, a = String(i).replace(/\/+$/, "") || "/", o = /* @__PURE__ */ new Set(), _ = (p) => {
    if (!p || o.has(p)) return;
    t.mkdirTree(p);
    let u = p;
    for (; u && !o.has(u); ) {
    ...
    onEntry: (p) => {
      ...
      _(w(u)), !(!r && ((h = t.fileExists) != null && h.call(t, u))) && (t.writeFile(u, p.data), c.fileCount % 1e3 === 0 && s({
...
function dt(e) {
  return H(e) ? e : new Blob([e]).stream();
}
async function pt(e) {
  if (!H(e))
    return [e];
  const t = e.getReader(), i = [];
  try {
    for (; ; ) {
...
`)
    ...
    const o = t.slice(s + 1, a - 1), _ = o.indexOf("=");
    if (_ === -1)
      throw new Error("Malformed tar stream: invalid PAX record");
    i[o.slice(0, _)] = o.slice(_ + 1), n = a;
  }
  return i;
}
const X = `<?php
...
async function ht(e, t) {
  const i = l(t, "wp-config.php");
  !e.fileExists(i) && e.fileExists(l(t, "wp-config-sample.php")) && await e.writeFile(
    i,
    await e.readFileAsBuffer(
      l(t, "wp-config-sample.php")
    )
...
async function Vt(e, t, i) {
  const n = k({ wpConfigPath: t, constants: i });
  if ((await e.run({
    code: `${X}
...
async function $t(e, t, i) {
  const n = Object.keys(i), s = k({ wpConfigPath: t, constantNames: n }), r = await e.run({
    code: `${X}
...
async function L(e, {
  ...
  if (!n.isDir(s) && !t && !i && !gt(n))
    throw new Error("Error connecting to the MySQL database.");
}
function gt(e) {
  const t = l(e.documentRoot, "wp-config.php");
...
function mt(e, t) {
  var r, a;
  if (!E(t.phpVersion)) return;
  const i = (((r = t.phpIniEntries) == null ? void 0 : r.disable_functions) ?? "").split(",").map((o) => o.trim()).filter((o) => o), s = {
    disable_functions: Array.from(
      /* @__PURE__ */ new Set([...i, ...V])
    ).join(","),
    allow_url_fopen: "0"
  };
  (a = t.phpIniEntries) != null && a["date.timezone"] || (s["date.timezone"] = "UTC"), v(e, s);
}
async function Tt(e, t) {
  var a, o;
  const i = await e.getPrimaryPhp();
  if ((a = t.hooks) != null && a.beforeWordPressFiles && await t.hooks.beforeWordPressFiles(i), t.wordPressZip && await Q(i, await t.wordPressZip, {
    expectedFileCount: t.wordPressBundleFileCount
  }), t.constants)
    for (const _ in t.constants)
      i.defineConstant(_, t.constants[_]);
  i.defineConstant("WP_HOME", t.siteUrl), i.defineConstant("WP_SITEURL", t.siteUrl), await Et(i, e.documentRoot), await Le(i, e.documentRoot), (o = t.hooks) != null && o.beforeDatabaseSetup && await t.hooks.beforeDatabaseSetup(i);
  let n = !1;
  t.sqliteIntegrationPluginZip && (n = !0, await K(
    i,
  ...
  s === "install-from-existing-files-if-needed") && (await L(e, {
    usesSqlite: n,
    hasCustomDatabasePath: r
  }), await Lt(i, e)), e;
}
async function Et(e, t) {
  const i = l(t, "wp-config.php"), n = l(t, "wp-config-sample.php");
...
async function wt(e, t) {
  const i = l(t, "wp-content"), n = l(i, "db.php");
...
async function Lt(e, t) {
  try {
    ...
    $.warn("Legacy PHP WordPress installation error:", i);
  }
  await Je(e, t.absoluteUrl);
}
async function yt(e) {
  var r, a, o, _, c, d;
  const t = Nt(e, e.documentRoot);
  if (t !== null) {
  ...
  if (!(((r = n.text) == null ? void 0 : r.includes("Success")) || ((a = n.text) == null ? void 0 : a.includes("successful")) || ((o = n.text) == null ? void 0 : o.includes("Finished")) || ((_ = n.text) == null ? void 0 : _.includes("Already Installed")) || ((c = n.text) == null ? void 0 : c.includes("already have WordPress installed")) || !1))
    throw new Error(
      `Failed to install WordPress – installer responded with "${(d = n.text) == null ? void 0 : d.substring(
        0,
        100
      )}"`
    );
...
async function Ot(e) {
  try {
    ...
    $.warn("runDbDeltaOnly failed (non-fatal):", t);
  }
}
function Nt(e, t) {
  const i = l(t, "wp-includes/version.php");
...
async function At(e, t) {
  ...
  if ((a = t.hooks) != null && a.beforeWordPressFiles && await t.hooks.beforeWordPressFiles(i), t.wordPressZip && await Q(i, await t.wordPressZip, {
    ...
    for (const _ in t.constants)
      i.defineConstant(_, t.constants[_]);
  t.dataSqlPath && (i.defineConstant("DB_DIR", w(t.dataSqlPath)), i.defineConstant("DB_FILE", te(t.dataSqlPath))), i.defineConstant("WP_HOME", t.siteUrl), i.defineConstant("WP_SITEURL", t.siteUrl), await ht(i, e.documentRoot), (o = t.hooks) != null && o.beforeDatabaseSetup && await t.hooks.beforeDatabaseSetup(i);
  let n = !1;
  t.sqliteIntegrationPluginZip && (n = !0, await K(
    i,
    await t.sqliteIntegrationPluginZip,
    { phpVersion: t.phpVersion }
  ), await Ee(i, e.documentRoot));
  const s = t.wordpressInstallMode ?? "download-and-install", r = !!t.dataSqlPath;
...
async function Pt(e) {
  Ut(e);
  const t = e.spawnHandler ?? z;
  async function i(s, r = !1) {
    const a = await e.createPhpRuntime(r), o = new Z(a);
    if (e.sapiName && o.setSapiName(e.sapiName), s && (o.requestHandler = s), e.phpIniEntries && v(o, e.phpIniEntries), mt(o, {
      phpVersion: e.phpVersion,
      phpIniEntries: e.phpIniEntries
    }), o.defineConstant("WP_SQLITE_AST_DRIVER", !0), e.constants)
      for (const _ in e.constants)
        o.defineConstant(_, e.constants[_]);
    return r && /**
    ...
    */
    !o.isFile("/internal/.boot-files-written") && (await kt(o, {
      phpVersion: e.phpVersion
    }), await A(o, "/", e.createFiles || {}), await Dt(
      o,
      l(new URL(e.siteUrl).pathname, "phpinfo.php")
    ), await A(o, "/internal", {
      ".boot-files-written": ""
...
async function x(e) {
  ...
  })).text !== "1" && $.warn("Failed to default to pretty permalinks after WP install.");
}
function St(e) {
  return {
...
const vt = "https://api.wordpress.org/core/stable-check/1.0/";
let R;
async function Qt() {
  R ?? (R = D(globalThis.fetch));
  const e = await R(
    vt
  );
  if (!e.ok)
...
async function Dt(e, t = "/phpinfo.php") {
  await e.writeFile(
    "/internal/shared/preload/phpinfo.php",
    `<?php
    // Render PHPInfo if the requested page is /phpinfo.php
    if ( isset($_SERVER['REQUEST_URI']) && ${f(
      t
    )} === $_SERVER['REQUEST_URI'] ) {
        phpinfo();
        exit;
...
async function K(e, t, i = {}) {
  ...
  const o = (await e.readFileAsText(
    ...
    "'{SQLITE_PLUGIN}'",
    f(l(n, "load.php"))
  ), _ = l(await e.documentRoot, "wp-content/db.php"), c = `
...
async function Q(e, t, i = {}) {
  ...
  const n = new Uint8Array(await t.slice(0, 4).arrayBuffer());
  if (at(n)) {
    const a = await ct(t.stream(), "zstd"), o = await ut(
      a,
      e,
    ...
    await T(e, t, "/tmp/unzipped-wordpress");
  e.fileExists("/tmp/unzipped-wordpress/wordpress.zip") && await T(
    e,
  ...
  if (!e.fileExists(l(s, "wp-config-sample.php"))) {
    const a = e.listFiles(s);
    if (a.length) {
      const o = a[0];
      e.fileExists(
        l(s, o, "wp-config-sample.php")
      ) && (s = l(s, o));
    }
  }
  const r = (a, o, _) => {
    if (_.isDir(a) && _.isDir(o))
      for (const c of _.listFiles(a)) {
        const d = l(a, c), p = l(o, c);
        r(d, p, _);
      }
    else {
      if (_.fileExists(o)) {
        ...
        $.warn(
          `Cannot unzip WordPress files at ${o}: ${c} already exists.`
        );
        return;
      }
      _.mv(a, o);
  ...
  r(s, e.documentRoot, e), e.fileExists(s) && e.rmdir(s, { recursive: !0 }), !e.fileExists(l(e.documentRoot, "wp-config.php")) && e.fileExists(l(e.documentRoot, "wp-config-sample.php")) && e.writeFile(
    l(e.documentRoot, "wp-config.php"),
    e.readFileAsText(
      l(e.documentRoot, "/wp-config-sample.php")
    )
  );
}
const Ct = D(fetch), qt = "https://github.com/WordPress/WordPress/archive/refs/heads/master.zip";
async function zt(e = "latest") {
  if (e === null)
    e = "latest";
...
export {
  _t as StreamingTarParser,
  Pt as bootRequestHandler,
  At as bootWordPress,
  Yt as bootWordPressAndRequestHandler,
  ct as createDecodedTarStream,
  Vt as defineWpConfigConstants,
  ht as ensureWpConfig,
  ut as extractTarStreamToPhp,
  St as getFileNotFoundActionForWordPress,
  Kt as getLoadedWordPressVersion,
  Qt as getWordPressStableVersions,
  Xt as isZipBundle,
  at as isZstdBundle,
  Dt as preloadPhpInfoRoute,
  K as preloadSqliteIntegration,
  zt as resolveWordPressRelease,
  ot as sanitizeTarPath,
  kt as setupPlatformLevelMuPlugins,
  Q as unzipWordPress,
  Rt as versionStringToLoadedWordPressVersion,
  It as wordPressRewriteRules
};
