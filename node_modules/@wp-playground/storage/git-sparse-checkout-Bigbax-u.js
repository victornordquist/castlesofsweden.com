import { c as w, G as f, p as x, a as k, O as G, b as T, d as B, e as E, f as P } from "./isomorphic-git-internals-DwkB8rfP.js";
import { GitAuthenticationError as g } from "./index.js";
...
`)
  ...
  const r = A(n.body), i = await x(r), c = Buffer.from(await w(i.packfile)), s = await k.fromPack({
    pack: c
  }), d = s.read;
...
`)
  ...
  const r = A(n.body), i = await x(r), c = Buffer.from(await w(i.packfile));
...
//# sourceMappingURL=git-sparse-checkout-Bigbax-u.js.map
